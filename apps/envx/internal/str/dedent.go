...
// tab-sensitive formats like YAML). Leading and trailing blank lines are trimmed.
//
// An optional second argument specifies the number of spaces to preserve in
// front of each non-empty line after dedenting.
