...
**Every `func` and `type` — exported or not, no matter how trivial — must contain doc comments. This is mandatory and is never skipped.** The header should be a Go-style doc comment that begins with the symbol's name and clearly states its purpose:
