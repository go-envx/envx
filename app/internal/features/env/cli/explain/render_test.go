		...
		Entries: []actionResultEntry{
			{
				...
				Resolution: env.Resolution{
					Kind: env.KindConfigValue, Severity: env.SeverityOK, Code: "OK",
				},
			},
		},
	}
		...
		Entries: []actionResultEntry{
			{
				...
				Source:  "env/app.yaml",
				Resolution: env.Resolution{
					Kind:     env.KindSecretReference,
					Severity: env.SeverityError,
					Code:     "SECRET_NOT_FOUND",
				},
			},
		},
		Summary: env.ExplanationSummary{Errors: 1},
	}
...
func TestRenderBannerSplitsAndPluralizes(t *testing.T) {
	...
	res := actionResult{
		Summary: env.ExplanationSummary{Errors: 3, Warnings: 1},
	}
		...
		Entries: []actionResultEntry{
			{
				...
				Source: "env/app.yaml",
				Resolution: env.Resolution{
					Kind:        env.KindConfigValue,
					Severity:    env.SeverityOK,
					Code:        "OK",
					Resolved:    "",
					HasResolved: true,
				},
